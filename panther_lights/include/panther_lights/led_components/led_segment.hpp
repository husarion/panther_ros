...
#ifndef PANTHER_LIGHTS_LED_COMPONENTS_LED_SEGMENT_HPP_
#define PANTHER_LIGHTS_LED_COMPONENTS_LED_SEGMENT_HPP_
...
#endif  // PANTHER_LIGHTS_LED_COMPONENTS_LED_SEGMENT_HPP_
