...
class MockAPA102 : public panther_lights::APA102Interface
{
public:
...
panther_lights::LightsDriverNode::LightsDriverNode(
...
public:
  ...
  void FrameCB(
    const ImageMsg::UniquePtr & msg, const panther_lights::APA102Interface::SharedPtr & panel,
