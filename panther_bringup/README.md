...
- `exit_on_wrong_hw` [*bool*, default=**true**]: if set to *ture* and incorrect hadrware is detected kill entire roslaunch. If set to *false* do not launch nodes and only spin dummy welcome_msg_node.
