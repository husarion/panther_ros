...
- `robot_description` [*string*, default=**$(find panther_description)/urdf/panther.urdf.xacro**]: robot description in Xacro and URDF format. URDF itself contains its own arguments that are responsible for wheel selection and IMU position.
