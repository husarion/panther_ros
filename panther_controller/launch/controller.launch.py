...
def generate_launch_description():
    ...
    robot_description_content = Command(
        [
            ...
            battery_config_path,
            " imu_xyz:=",
            f"\"{os.environ.get('ROBOT_IMU_LOCALIZATION_X', '0.168')} {os.environ.get('ROBOT_IMU_LOCALIZATION_Y', '0.028')} {os.environ.get('ROBOT_IMU_LOCALIZATION_Z', '0.083')}\"",
            " imu_rpy:=",
            f"\"{os.environ.get('ROBOT_IMU_ORIENTATION_R', '3.14')} {os.environ.get('ROBOT_IMU_ORIENTATION_P', '-1.57')} {os.environ.get('ROBOT_IMU_ORIENTATION_Y', '0.0')}\"",
            " namespace:=",
            namespace,
            " components_config_path:=",
            components_config_path,
