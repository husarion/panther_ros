...
| ✅   | ✅   | `lights_bt_project_path`     | Path to BehaviorTree project file, responsible for lights management. <br/> ***string:*** [`PantherLightsBT.btproj`](./husarion_ugv_manager/behavior_trees/PantherLightsBT.btproj)                                                                                                                                 |
...
| ✅   | ✅   | `safety_bt_project_path`     | Path to BehaviorTree project file, responsible for safety and shutdown management. <br/> ***string:*** [`PantherSafetyBT.btproj`](./husarion_ugv_manager/behavior_trees/PantherSafetyBT.btproj)                                                                                                                    |
