...
inline void BatteryPublisher::BatteryStatusLogger(const BatteryStateMsg & battery_state)
{
...
inline bool BatteryPublisher::ChargerConnected() const { return charger_connected_; }
