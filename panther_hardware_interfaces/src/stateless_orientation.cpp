...
template <typename T>
static inline void crossProduct(T ax, T ay, T az, T bx, T by, T bz, T & rx, T & ry, T & rz)
{
  rx = ay * bz - az * by;
  ry = az * bx - ax * bz;
  rz = ax * by - ay * bx;
...
bool StatelessOrientation::computeOrientation(
  WorldFrame::WorldFrame frame, geometry_msgs::msg::Vector3 A, geometry_msgs::msg::Vector3 E,
